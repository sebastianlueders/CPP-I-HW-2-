...
https://www.geeksforgeeks.org/cpp/std-inner_product-in-cpp/
...
double euclideanLength(const std::vector<double>& v)
{
    double vSqSum = std::inner_product(v.begin(), v.end(), v.begin(), 0.0);
    return sqrt(vSqSum);
}
...
int main() 
{
    ...
    std::cout << std::format("The Euclidean Length of this {}-Dimensional Vector is: {}\n", n, euclideanLength(src));
